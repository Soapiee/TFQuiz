...
import me.soapiee.tfquiz.listeners.GameEvents;
import me.soapiee.tfquiz.listeners.PlayerListener;
import me.soapiee.tfquiz.managers.*;
import me.soapiee.tfquiz.utils.*;
    ...
    public void onDisable() {
        ...
        for (Game game : gameManager.getGames()) {
            ...
            if (!game.getSigns().isEmpty())
                for (GameSign sign : game.getSigns()) versionManager.getSignHandler().despawn(sign);
        }
    }
